...
def run():
    ...
    if slack_client.rtm_connect(with_team_state=False):
        ...
        # get id from the auth.test api
        bot_username = slack_client.api_call("auth.test")["user_id"]
        while True:
            command, channel = parse_bot_commands(bot_username, slack_client.rtm_read())
            if command:
...
def parse_bot_commands(bot_username, slack_events):
    """
